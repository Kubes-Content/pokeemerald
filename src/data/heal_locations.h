static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_HOME_TOWN_1 - 1] = {MAP_GROUP(HOME_TOWN), MAP_NUM(HOME_TOWN), 3, 7},
    [HEAL_LOCATION_HOME_TOWN_2 - 1] = {MAP_GROUP(HOME_TOWN), MAP_NUM(HOME_TOWN), 5, 7},
    [HEAL_LOCATION_MID_TOWN - 1] = {MAP_GROUP(MID_TOWN), MAP_NUM(MID_TOWN), 0, 0},
    [HEAL_LOCATION_LEFT_GYM_ZONE - 1] = {MAP_GROUP(LEFT_GYM_ZONE), MAP_NUM(LEFT_GYM_ZONE), 12, 17},
    [HEAL_LOCATION_LEFT_GYM_1F - 1] = {MAP_GROUP(LEFT_GYM_1F), MAP_NUM(LEFT_GYM_1F), 0, 0},
};
