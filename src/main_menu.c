...
static void Task_KubesNewGame(u8);
...
static void ClearGenderWindowTilemap(u8, u8, u8, u8, u8, u8);
...
const u8 BoyOrGirlQuestionT[] = _("Are you a boy or a girl?$");
...
static void Task_NewGameBirchSpeech_Init(u8 taskId)
{
    ...
    gTasks[taskId].func = Task_NewGame;
